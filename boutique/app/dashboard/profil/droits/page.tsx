...
import MesDroits from "../../../components/dashboard-profil/MesDroits";

/*
  "Mes droits" (menu du compte, voir DashboardHeader) : grille des quatre
  rôles fixes de la boutique et ce que chacun peut faire — cf. capture
  fournie.
*/
