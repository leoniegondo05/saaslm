...
import MonProfil from "../../components/dashboard-profil/MonProfil";

/*
  "Voir mon profil" (menu du compte, voir DashboardHeader) : identité,
  code personnel à scanner, détails du compte — cf. captures fournies.
*/
