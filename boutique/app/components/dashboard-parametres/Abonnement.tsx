...
export default function Abonnement({ first = false }: { first?: boolean }) {
  ...
  return (
    <>
      <SectionHeader
        eyebrow="Abonnement"
        title="Ce que vous versez chaque mois"
        subtitle="La carte qui vous prélève, et l'historique."
        first={first}
        layout="inline"
      />
      ...
      <div className="grid gap-3">
        <div className="rounded-2xl border border-brand-pink/20 bg-brand-pink/[0.05] p-4 shadow-[0_8px_20px_-6px_rgba(20,18,32,0.18)]">
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div>
              <p className="text-[10px] uppercase tracking-[0.14em] text-[var(--dashboard-text)]/40">Votre abonnement</p>
              <p className="mt-1.5 text-[28px] font-bold tracking-tight text-[var(--dashboard-text)]">
                ...
                <span className="ml-2 text-xs font-normal text-[var(--dashboard-text)]/50">par mois</span>
              </p>
              <p className="mt-1.5 text-xs text-[var(--dashboard-text)]/50">
                Versé à votre partenaire agréé, Groupe Logistique Ivoire.
              </p>
            </div>
            <div className="text-right">
              <p className="text-[10px] uppercase tracking-[0.14em] text-[var(--dashboard-text)]/40">Prochaine échéance</p>
              <p className="mt-1.5 text-base font-bold text-[var(--dashboard-text)]">14 sept.</p>
              <p className="mt-0.5 text-[11px] text-[var(--dashboard-text)]/50">dans 8 jours</p>
            </div>
          </div>
          <div className="my-4 h-px bg-[var(--dashboard-text)]/10" />
          <p className="text-xs text-[var(--dashboard-text)]/50">
            L&apos;abonnement, c&apos;est votre place dans le réseau de votre partenaire : ses
            entrepôts, ses livreurs, son catalogue. Il est dû qu&apos;il y ait des ventes ou non.
          </p>
        </div>

        <Card title="Moyen de prélèvement" titleTab className="!bg-[var(--dashboard-card-bg)]">
        ...
        <Card className="!bg-[var(--dashboard-card-bg)]">
          <div className="flex items-center justify-between gap-3">
            <div className="min-w-0 flex-1">
              <p className="text-xs font-bold text-[var(--dashboard-text)]">Prélèvement automatique</p>
              <p className="mt-0.5 text-[11px] leading-snug text-[var(--dashboard-text)]/50">
                Actif par défaut. Le décocher vous oblige à payer à la main chaque mois, et un
                retard suspend la boutique.
              </p>
            </div>
            <ToggleSwitch
        ...
        <Card title="Historique des abonnements" titleTab className="!bg-[var(--dashboard-card-bg)]">
              ...
              <div key={date} className="flex flex-wrap items-center gap-3 py-2.5 first:pt-0 last:pb-0">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="mt-0.5 text-[11px] text-[var(--dashboard-text)]/50">
                    Abonnement mensuel · Groupe Logistique Ivoire
                  </p>
                </div>
        ...
        <div className="rounded-2xl border border-[#ffb0b1]/40 bg-[#ffe1e2]/30 p-4">
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div className="max-w-lg">
              <p className="text-xs font-bold text-[var(--dashboard-text)]">Résilier l&apos;abonnement</p>
              <p className="mt-1.5 text-[11px] leading-relaxed text-[var(--dashboard-text)]/60">
                Vous restez rattaché à Groupe Logistique Ivoire : le lien entre vous ne se coupe
                pas. C&apos;est votre boutique qui s&apos;arrête. À la date de fin, elle cesse de
                fonctionner et vous perdez vos accès — ses entrepôts, ses livreurs et son catalogue
                ne vous servent plus, faute de boutique pour vendre.
              </p>
            </div>
            <button
              type="button"
          ...
          <div className="space-y-2">
            <EtapeRow numero={1} texte="La boutique reste ouverte jusqu'à la fin du mois déjà payé." />
            <EtapeRow numero={2} texte="Vos dépôts de stock doivent être récupérés avant cette date." />
            <EtapeRow numero={3} texte="Les commandes déjà parties iront jusqu'à leur livraison." />
            <EtapeRow
              numero={4}
              texte="À la date de fin, la boutique s'arrête et vos accès se ferment. Le rattachement au partenaire, lui, reste en place : reprendre l'abonnement vous rouvre la même boutique."
            />
          </div>
        </div>
      </div>
