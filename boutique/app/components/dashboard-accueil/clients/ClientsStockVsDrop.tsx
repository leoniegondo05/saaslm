        ...
        >
          ...
          <div className="mt-4 space-y-2 text-[11px]">
            ...
            <div className="flex justify-between border-t border-[var(--dashboard-text)]/10 pt-1.5 font-bold">
              ...
              <span className="text-[#10b981] font-figures">4,4 / 5</span>
            </div>
          </div>
        </div>
        ...
        >
          ...
          <div className="mt-4 space-y-2 text-[11px]">
            ...
            <div className="flex justify-between">
              ...
              <span className="font-semibold font-figures text-[var(--dashboard-text)]">76 %</span>
            </div>
            <div className="flex justify-between">
              <span className="text-[var(--dashboard-text)]/55">
                {t("Litige pour produit non conforme", "Disputes for non-compliant item")}
            ...
            <div className="flex justify-between border-t border-[var(--dashboard-text)]/10 pt-1.5 font-bold">
              ...
              <span className="text-[#f59e0b] font-figures">3,8 / 5</span>
            </div>
          </div>
        </div>
      </div>
