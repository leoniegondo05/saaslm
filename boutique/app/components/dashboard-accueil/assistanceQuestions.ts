...
export const ASSISTANCE_QUESTIONS: Record<AccueilTab, AssistanceQuestion[]> = {
  ...
  Produits: [
    { fr: "Quel produit me rapporte le plus sur la période ?", en: "Which product earns me the most this period?" },
    { fr: "Quels sont mes produits les moins rentables ?", en: "Which of my products are least profitable?" },
    { fr: "Suis-je cher ou pas cher par rapport au réseau sur un produit drop ?", en: "Am I priced high or low against the network on a drop product?" },
    { fr: "Quelle nature de produit vend le plus, stockage ou drop ?", en: "Which product type sells the most, warehousing or drop?" },
    { fr: "Quelle marge nette fait chacun de mes produits drop ?", en: "What net margin does each of my drop products make?" },
    { fr: "Combien de nouveaux produits sont disponibles ce mois ?", en: "How many new products are available this month?" },
    { fr: "Où se situe mon prix par rapport au bas, moyen, haut du marché ?", en: "Where does my price sit against the market's low, average, high?" },
  ],
  Alertes: [
